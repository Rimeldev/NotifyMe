...
const TestimonialCard = ({
	...
	return (
		<>
				...
				{isExpanded && (
					<div className="fixed inset-0 h-screen overflow-hidden z-50">
						...
						<motion.div
							...
							className="max-w-5xl mx-auto bg-gradient-to-b from-card to-background h-full z-[60] p-4 md:p-10 rounded-3xl relative md:mt-10"
						>
							<button
			...
			>
				<div
					className={`${index % 2 === 0 ? "rotate-0" : "-rotate-0"} rounded-3xl bg-gradient-to-b from-card to-background h-[500px] md:h-[550px] w-80 md:w-96 overflow-hidden flex flex-col items-center justify-center relative z-10 shadow-md border border-white/10`}
				>
